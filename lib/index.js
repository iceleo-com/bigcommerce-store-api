...
const store_information_v3_api_1 = require("./apis/store-information-v3.api");
...
const tax_customers_v3_api_1 = require("./apis/tax-customers-v3.api");
...
__exportStar(require("./apis/store-information-v3.api"), exports);
...
__exportStar(require("./apis/tax-customers-v3.api"), exports);
...
class BigCommerceStoreApi {
    constructor(config) {
        ...
        this.v3 = {
            ...
            storeInformation: new store_information_v3_api_1.StoreInformationV3Api(this.request),
            ...
            taxCustomers: new tax_customers_v3_api_1.TaxCustomersV3Api(this.request),
