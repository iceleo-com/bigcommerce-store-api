...
export declare class StoreInformationV3Api {
    ...
    deleteStoreMetafield(metafieldId: StoreInformationV3ApiSpecs.DeleteStoreMetafieldData['path']['metafieldId']): Promise<RequestErrorResponse<404, Required<StoreInformationV3ApiSpecs.NotFound>> | RequestSuccessResponse<204, Required<{
        [key: string]: unknown;
    }>>>;
}
