...
exports.TaxPropertiesV3Api = exports.TaxPropertiesV3ApiSpecs = void 0;
exports.TaxPropertiesV3ApiSpecs = __importStar(require("../generated/tax-properties-v3"));
class TaxPropertiesV3Api {
    ...
    getProductTaxProperties(query) {
        return this.request.get({
            path: 'v3/tax/products/properties',
            query,
        });
    }
    getProductsTaxProperties(...args) {
...
exports.TaxPropertiesV3Api = TaxPropertiesV3Api;
