...
export declare class AcceptedMethodsV3Api {
    ...
    paymentsMethodsGet(query?: AcceptedMethodsV3ApiSpecs.PaymentsMethodsGetData['query']): Promise<RequestSuccessResponse<200, Required<{
    ...
    getPaymentMethods(...args: Parameters<AcceptedMethodsV3Api['paymentsMethodsGet']>): Promise<RequestSuccessResponse<200, Required<{
        data?: Array<AcceptedMethodsV3ApiSpecs.PaymentMethodFull>;
        meta?: {
            [key: string]: unknown;
        };
