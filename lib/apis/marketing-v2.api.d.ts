...
export declare class MarketingV2Api {
    ...
    deleteCoupons(query?: MarketingV2ApiSpecs.DeleteCouponsData['query']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
    getCouponsCount(): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<200, Required<{
        count?: number;
    }>>>;
    ...
    deleteCoupon(id: MarketingV2ApiSpecs.DeleteCouponData['path']['id']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
    ...
    deleteBanners(): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
    ...
    deleteBanner(id: MarketingV2ApiSpecs.DeleteBannerData['path']['id']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
    getBannersCount(): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<200, Required<{
        count?: number;
    }>>>;
    ...
    deleteGiftCertificate(id: MarketingV2ApiSpecs.DeleteGiftCertificateData['path']['id']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
