...
export declare class PagesV3Api {
    ...
    createPages(requestBody: PagesV3ApiSpecs.CreatePagesData['body'], query?: PagesV3ApiSpecs.CreatePagesData['query']): Promise<RequestSuccessResponse<201, Required<PagesV3ApiSpecs.PagesBulkCreatePagesResponse201>> | RequestErrorResponse<422, Required<PagesV3ApiSpecs.ResponseErrorDetailed>>>;
    ...
    deletePages(query?: PagesV3ApiSpecs.DeletePagesData['query']): Promise<RequestErrorResponse<422, Required<PagesV3ApiSpecs.ResponseErrorDetailed>> | RequestErrorResponse<404, Required<PagesV3ApiSpecs.ResponseErrorBrief>> | RequestSuccessResponse<204, Required<{
        [key: string]: unknown;
    }>>>;
    ...
    deletePage(pageId: PagesV3ApiSpecs.DeletePageData['path']['pageId']): Promise<RequestErrorResponse<404, Required<PagesV3ApiSpecs.ResponseErrorBrief>> | RequestSuccessResponse<204, Required<{
        [key: string]: unknown;
    }>>>;
}
