...
exports.ShippingV3Api = exports.ShippingV3ApiSpecs = void 0;
exports.ShippingV3ApiSpecs = __importStar(require("../generated/shipping-v3"));
class ShippingV3Api {
    constructor(request) {
    ...
    getChannelShippingSettings(channelId) {
        return this.request.get({
            path: `v3/shipping/settings/channels/${channelId}`,
        });
    }
    updateChannelShippingSettings(channelId, requestBody) {
        return this.request.put({
            path: `v3/shipping/settings/channels/${channelId}`,
            contentType: 'application/json',
            body: requestBody,
