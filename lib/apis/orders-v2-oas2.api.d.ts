...
export declare class OrdersV2Oas2Api {
    ...
    getOrders(query?: OrdersV2Oas2ApiSpecs.GetOrdersData['query']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void> | RequestSuccessResponse<200, OrdersV2Oas2ApiSpecs.OrderResp[]>>;
    ...
    getOrderCoupons(orderId: OrdersV2Oas2ApiSpecs.GetOrderCouponsData['path']['order_id'], query?: OrdersV2Oas2ApiSpecs.GetOrderCouponsData['query']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void> | RequestSuccessResponse<200, OrdersV2Oas2ApiSpecs.OrderCouponsBase[]>>;
    getOrderFees(orderId: OrdersV2Oas2ApiSpecs.GetOrderFeesData['path']['order_id']): Promise<RequestSuccessResponse<204, void> | RequestSuccessResponse<200, OrdersV2Oas2ApiSpecs.OrderFeesResp[]> | RequestErrorResponse<404, OrdersV2Oas2ApiSpecs.OrdersOrderIdFeesGetResponsesContentApplicationJsonSchemaItems[]>>;
    getOrderMessages(orderId: OrdersV2Oas2ApiSpecs.GetOrderMessagesData['path']['order_id'], query?: OrdersV2Oas2ApiSpecs.GetOrderMessagesData['query']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void> | RequestSuccessResponse<200, OrdersV2Oas2ApiSpecs.OrderMessagesItems[]>>;
    ...
    getOrderShipments(orderId: OrdersV2Oas2ApiSpecs.GetOrderShipmentsData['path']['order_id'], query?: OrdersV2Oas2ApiSpecs.GetOrderShipmentsData['query']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void> | RequestSuccessResponse<200, OrdersV2Oas2ApiSpecs.OrderShipment[]>>;
