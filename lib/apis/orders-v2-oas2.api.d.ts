...
export declare class OrdersV2Oas2Api {
    ...
    deleteOrder(orderId: OrdersV2Oas2ApiSpecs.DeleteOrderData['path']['order_id']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
    ...
    deleteOrders(query?: OrdersV2Oas2ApiSpecs.DeleteOrdersData['query']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
    ...
    deleteOrderShipments(orderId: OrdersV2Oas2ApiSpecs.DeleteOrderShipmentsData['path']['order_id']): Promise<RequestErrorResponse<400, void> | RequestSuccessResponse<204, void>>;
    ...
    getOrderConsignments(orderId: OrdersV2Oas2ApiSpecs.GetOrderConsignmentsData['path']['order_id'], query?: OrdersV2Oas2ApiSpecs.GetOrderConsignmentsData['query']): Promise<RequestSuccessResponse<200, Required<OrdersV2Oas2ApiSpecs.OrderConsignmentGet>> | RequestErrorResponse<404, {
        status?: number;
        message?: string;
    }[]>>;
    ...
    getOrderFees(orderId: OrdersV2Oas2ApiSpecs.GetOrderFeesData['path']['order_id']): Promise<RequestSuccessResponse<200, Required<OrdersV2Oas2ApiSpecs.OrderFeesResp>> | RequestErrorResponse<404, {
        status?: number;
        message?: string;
    }[]>>;
}
