...
export declare class AbandonedCartsV3Api {
    ...
    getGlobalAbandonedCartSettings(query?: AbandonedCartsV3ApiSpecs.GetGlobalAbandonedCartSettingsData['query']): Promise<RequestSuccessResponse<200, Required<AbandonedCartsV3ApiSpecs.GlobalAbandonedCartSettingsResponse>> | RequestErrorResponse<401, Required<AbandonedCartsV3ApiSpecs.ErrorResponse>>>;
