...
class SitesV3Api {
    ...
    postSiteRoute(siteId, requestBody) {
        return this.request.post({
            path: `v3/sites/${siteId}/routes`,
            contentType: 'application/json',
            body: requestBody,
    ...
    createSiteRoute(...args) {
        return this.postSiteRoute(...args);
    }
    putSitesBySiteIdRoutes(siteId, requestBody) {
        return this.request.put({
            path: `v3/sites/${siteId}/routes`,
            contentType: 'application/json',
            body: requestBody,
    ...
    putSiteRoute(siteId, routeId, requestBody) {
        return this.request.put({
            path: `v3/sites/${siteId}/routes/${routeId}`,
            contentType: 'application/json',
            body: requestBody,
    ...
    deleteSiteRoute(...args) {
        return this.deleteRoute(...args);
    }
    getSitesIdCertificate(siteId) {
        return this.request.get({
            path: `v3/sites/${siteId}/certificate`,
        });
    }
    getSiteCertificate(...args) {
        return this.getSitesIdCertificate(...args);
    }
    putSiteIdCertificate(siteId, requestBody) {
        return this.request.put({
            path: `v3/sites/${siteId}/certificate`,
            contentType: 'application/json',
            body: requestBody,
