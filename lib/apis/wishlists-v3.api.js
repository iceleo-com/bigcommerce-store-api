...
class WishlistsV3Api {
    ...
    wishlistsItemsByIdDelete(wishlistId, itemId) {
        return this.request.delete({
            path: `v3/wishlists/${wishlistId}/items/${itemId}`,
        });
    }
    deleteWishlistItem(...args) {
        return this.wishlistsItemsByIdDelete(...args);
    }
    wishlistsByIdGet(wishlistId) {
        return this.request.get({
    ...
    wishlistsByIdPut(wishlistId, requestBody) {
    ...
    wishlistsByIdDelete(wishlistId) {
        return this.request.delete({
            path: `v3/wishlists/${wishlistId}`,
        });
    }
    ...
    wishlistsItemsByIdPost(wishlistId, requestBody) {
        return this.request.post({
