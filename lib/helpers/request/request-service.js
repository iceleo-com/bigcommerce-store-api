...
const request_service_helper_1 = require("./request-service.helper");
...
class RequestService {
    ...
    request(method, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const normalizedPath = (0, request_service_helper_1.buildPath)(path, query);
            ...
            const response = yield fetch(url, {
                method,
                headers,
                body: (0, request_service_helper_1.parseBody)(body, (contentType || 'application/json')),
            })
                .catch((error) => {
            ...
            const result = response.body === null || (yield response.text()).trim() === ''
                ? {}
                : yield response
                    .json()
                    .catch((error) => {
