...
export class ProductsV3Api {
     ...
     * This endpoint accepts a `video` array. To create a product video that accepts a `video` object, see [Create a Product Video](/developer/api-reference/rest/admin/catalog/products/videos/create-product-video) for information.
     */
    createProduct(
        requestBody: ProductsV3ApiSpecs.CreateProductData['body'],
        query?: ProductsV3ApiSpecs.CreateProductData['query'],
    ) {
        return this.request.post<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.CreateProductResponses[200]>>,(RequestErrorResponse<409, Required<ProductsV3ApiSpecs.CreateProductErrors[409]>> | RequestErrorResponse<422, Required<ProductsV3ApiSpecs.CreateProductErrors[422]>>)>({
            path: 'v3/catalog/products',
     ...
     * Delete Products
     *
     * To delete *Product* objects, you must include a filter, such as `id:in` or any other supported query parameter. This requirement prevents you from inadvertently deleting every *Product* in a store with an unfiltered request. A `DELETE` request with no filter returns a `422` response.
     ...
     **Example**:
     ...
     No single request deletes an entire catalog; the filter requirement and the 250-product limit are both intentional safeguards against mass deletion. To remove every product, delete in batches until the catalog is empty:

     1. Fetch a page of product IDs with `GET /v3/catalog/products?limit=250&include_fields=id`.
     2. Delete that batch with `DELETE /v3/catalog/products?id:in={comma-separated IDs}`.
     3. Repeat from step 1 until `GET /v3/catalog/products` returns an empty `data` array.

     Deletions take effect immediately, so each request in step 1 reflects the products removed by the previous batch. Keep requesting the first page rather than paging through offsets, since the list shrinks as you delete.
     */
    deleteProducts(
        query?: ProductsV3ApiSpecs.DeleteProductsData['query'],
    ) {
        return this.request.delete<RequestSuccessResponse<204, Required<ProductsV3ApiSpecs.DeleteProductsResponses[204]>>,RequestErrorResponse<422, Required<ProductsV3ApiSpecs.DeleteProductsErrors[422]>>>({
            path: 'v3/catalog/products',
            query,
        });
    }
    ...
    updateProduct(
        ...
        return this.request.put<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.UpdateProductResponses[200]>>,(RequestErrorResponse<404, Required<ProductsV3ApiSpecs.UpdateProductErrors[404]>> | RequestErrorResponse<409, Required<ProductsV3ApiSpecs.UpdateProductErrors[409]>> | RequestErrorResponse<422, Required<ProductsV3ApiSpecs.UpdateProductErrors[422]>>)>({
            path: `v3/catalog/products/${productId}`,
            contentType: 'application/json',
            body: requestBody,
            query,
    ...
    getProductCustomFields(
        ...
        return this.request.get<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.GetProductCustomFieldsResponses[200]>>,(RequestErrorResponse<403, Required<ProductsV3ApiSpecs.GetProductCustomFieldsErrors[403]>> | RequestErrorResponse<404, Required<ProductsV3ApiSpecs.GetProductCustomFieldsErrors[404]>> | RequestErrorResponse<405, Required<ProductsV3ApiSpecs.GetProductCustomFieldsErrors[405]>>)>({
    ...
    createProductCustomField(
        ...
        return this.request.post<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.CreateProductCustomFieldResponses[200]>>,(RequestErrorResponse<403, Required<ProductsV3ApiSpecs.CreateProductCustomFieldErrors[403]>> | RequestErrorResponse<404, Required<ProductsV3ApiSpecs.CreateProductCustomFieldErrors[404]>> | RequestErrorResponse<405, Required<ProductsV3ApiSpecs.CreateProductCustomFieldErrors[405]>> | RequestErrorResponse<422, Required<ProductsV3ApiSpecs.CreateProductCustomFieldErrors[422]>>)>({
            path: `v3/catalog/products/${productId}/custom-fields`,
            contentType: 'application/json',
            body: requestBody,
        });
    ...
    getProductCustomField(
        ...
        return this.request.get<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.GetProductCustomFieldResponses[200]>>,(RequestErrorResponse<403, Required<ProductsV3ApiSpecs.GetProductCustomFieldErrors[403]>> | RequestErrorResponse<404, Required<ProductsV3ApiSpecs.GetProductCustomFieldErrors[404]>> | RequestErrorResponse<405, Required<ProductsV3ApiSpecs.GetProductCustomFieldErrors[405]>>)>({
    ...
    updateProductCustomField(
        ...
        return this.request.put<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.UpdateProductCustomFieldResponses[200]>>,(RequestErrorResponse<403, Required<ProductsV3ApiSpecs.UpdateProductCustomFieldErrors[403]>> | RequestErrorResponse<404, Required<ProductsV3ApiSpecs.UpdateProductCustomFieldErrors[404]>> | RequestErrorResponse<405, Required<ProductsV3ApiSpecs.UpdateProductCustomFieldErrors[405]>> | RequestErrorResponse<422, Required<ProductsV3ApiSpecs.UpdateProductCustomFieldErrors[422]>>)>({
            path: `v3/catalog/products/${productId}/custom-fields/${customFieldId}`,
            contentType: 'application/json',
            body: requestBody,
        });
    ...
    deleteProductCustomField(
        ...
        return this.request.delete<RequestSuccessResponse<204, Required<ProductsV3ApiSpecs.DeleteProductCustomFieldResponses[204]>>,(RequestErrorResponse<403, Required<ProductsV3ApiSpecs.DeleteProductCustomFieldErrors[403]>> | RequestErrorResponse<404, Required<ProductsV3ApiSpecs.DeleteProductCustomFieldErrors[404]>> | RequestErrorResponse<405, Required<ProductsV3ApiSpecs.DeleteProductCustomFieldErrors[405]>>)>({
            path: `v3/catalog/products/${productId}/custom-fields/${customFieldId}`,
        });
    }
    ...
    getProductImages(
        ...
        return this.request.get<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.GetProductImagesResponses[200]>>,RequestErrorResponse<404, Required<ProductsV3ApiSpecs.GetProductImagesErrors[404]>>>({
    ...
    getProductReviews(
        ...
        return this.request.get<RequestSuccessResponse<200, Required<ProductsV3ApiSpecs.GetProductReviewsResponses[200]>>,RequestErrorResponse<404, Required<ProductsV3ApiSpecs.GetProductReviewsErrors[404]>>>({
