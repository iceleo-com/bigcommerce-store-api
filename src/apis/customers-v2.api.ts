...
export class CustomersV2Api {
    ...
    createCustomerGroup(
        ...
        return this.request.post<RequestSuccessResponse<200, Required<CustomersV2ApiSpecs.CreateCustomerGroupResponses[200]>>,RequestErrorResponse<400, void>>({
            path: 'v2/customer_groups',
            contentType: 'application/json',
            body: requestBody,
        });
    ...
    updateCustomerGroup(
        ...
        return this.request.put<RequestSuccessResponse<200, Required<CustomersV2ApiSpecs.UpdateCustomerGroupResponses[200]>>,RequestErrorResponse<400, void>>({
            path: `v2/customer_groups/${customerGroupId}`,
            contentType: 'application/json',
            body: requestBody,
        });
